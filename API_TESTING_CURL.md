...
## Base URL
```
https://washdash-1.preview.emergentagent.com/api
```
...
### 1.3 Resend OTP
```bash
curl -X POST https://washdash-1.preview.emergentagent.com/api/auth/resend-otp \
  -H "Content-Type: application/json" \
  -d '{
    "email": "newuser@example.com"
  }'
...
curl -X GET https://washdash-1.preview.emergentagent.com/api/auth/me \
...
curl -X POST https://washdash-1.preview.emergentagent.com/api/auth/register \
  -H "Content-Type: application/json" \
  -H "Authorization: Bearer $TOKEN" \
  -d '{
...
curl -X GET https://washdash-1.preview.emergentagent.com/api/users \
  -H "Authorization: Bearer $TOKEN"
```
...
curl -X GET https://washdash-1.preview.emergentagent.com/api/users/$USER_ID \
  -H "Authorization: Bearer $TOKEN"
```
...
curl -X DELETE https://washdash-1.preview.emergentagent.com/api/users/$USER_ID \
  -H "Authorization: Bearer $TOKEN"
```
...
curl -X POST https://washdash-1.preview.emergentagent.com/api/orders \
  -H "Content-Type: application/json" \
  -H "Authorization: Bearer $TOKEN" \
  -d '{
...
curl -X GET https://washdash-1.preview.emergentagent.com/api/orders \
  -H "Authorization: Bearer $TOKEN"
```
...
curl -X GET https://washdash-1.preview.emergentagent.com/api/orders/$ORDER_ID \
  -H "Authorization: Bearer $TOKEN"
```
...
curl -X PUT https://washdash-1.preview.emergentagent.com/api/orders/$ORDER_ID \
  -H "Content-Type: application/json" \
  -H "Authorization: Bearer $TOKEN" \
  -d '{
    "status": "processing"
...
curl -X DELETE https://washdash-1.preview.emergentagent.com/api/orders/$ORDER_ID \
  -H "Authorization: Bearer $TOKEN"
```
...
curl -X GET https://washdash-1.preview.emergentagent.com/api/cases \
  -H "Authorization: Bearer $TOKEN"
```
...
curl -X GET https://washdash-1.preview.emergentagent.com/api/cases/$CASE_ID \
  -H "Authorization: Bearer $TOKEN"
```
...
curl -X PUT https://washdash-1.preview.emergentagent.com/api/cases/$CASE_ID \
  -H "Content-Type: application/json" \
  -H "Authorization: Bearer $TOKEN" \
  -d '{
    "status": "resolved",
...
curl -X POST https://washdash-1.preview.emergentagent.com/api/skus \
  -H "Content-Type: application/json" \
  -H "Authorization: Bearer $TOKEN" \
  -d '{
...
```bash
curl -X GET https://washdash-1.preview.emergentagent.com/api/skus
```
...
curl -X PUT https://washdash-1.preview.emergentagent.com/api/skus/$SKU_ID \
  -H "Content-Type: application/json" \
  -H "Authorization: Bearer $TOKEN" \
  -d '{
    "name": "Jacket - Dry Clean",
...
curl -X DELETE https://washdash-1.preview.emergentagent.com/api/skus/$SKU_ID \
  -H "Authorization: Bearer $TOKEN"
```
...
curl -X GET https://washdash-1.preview.emergentagent.com/api/notifications \
  -H "Authorization: Bearer $TOKEN"
```
...
curl -X PUT https://washdash-1.preview.emergentagent.com/api/notifications/$NOTIF_ID/read \
  -H "Authorization: Bearer $TOKEN"
```
...
curl -X PUT https://washdash-1.preview.emergentagent.com/api/notifications/read-all \
  -H "Authorization: Bearer $TOKEN"
```
...
curl -X GET https://washdash-1.preview.emergentagent.com/api/analytics/dashboard \
  -H "Authorization: Bearer $TOKEN"
```
...
```bash
curl -X POST https://washdash-1.preview.emergentagent.com/api/contact \
  -H "Content-Type: application/json" \
  -d '{
    "name": "John Doe",
...
curl -X POST https://washdash-1.preview.emergentagent.com/api/deliveries \
  -H "Content-Type: application/json" \
  -H "Authorization: Bearer $TOKEN" \
  -d '{
    "order_id": "order-uuid",
...
curl -X GET https://washdash-1.preview.emergentagent.com/api/deliveries \
  -H "Authorization: Bearer $TOKEN"
```
...
curl -X GET https://washdash-1.preview.emergentagent.com/api/deliveries/order/$ORDER_ID \
  -H "Authorization: Bearer $TOKEN"
```
...
# 1. Signup
echo "Testing Signup..."
SIGNUP_RESPONSE=$(curl -s -X POST https://washdash-1.preview.emergentagent.com/api/auth/signup \
  -H "Content-Type: application/json" \
  -d '{
...
VERIFY_RESPONSE=$(curl -s -X POST https://washdash-1.preview.emergentagent.com/api/auth/verify-otp \
  -H "Content-Type: application/json" \
  -d "{
    \"email\": \"testuser@example.com\",
    \"otp\": \"$OTP\"
...
# 4. Login
echo "Testing Login..."
LOGIN_RESPONSE=$(curl -s -X POST https://washdash-1.preview.emergentagent.com/api/auth/login \
  -H "Content-Type: application/json" \
  -d '{
    "email": "testuser@example.com",
    "password": "test123"
...
CASE_RESPONSE=$(curl -s -X POST https://washdash-1.preview.emergentagent.com/api/cases \
  -H "Content-Type: application/json" \
  -H "Authorization: Bearer $TOKEN" \
  -d '{
    "customer_id": "test-id",
